 ...
 *
 * Disassembly of SSDT11.aml, Fri Oct 23 18:40:38 2015
 *
 ...
 */
DefinitionBlock ("SSDT11.aml", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        {
            Store (Zero, _PSC) /* \_SB_.PCI0.RP05.PEGP._PSC */
            If (LNotEqual (DGPS, Zero))
            {
                _ON ()
                Store (Zero, DGPS) /* \_SB_.PCI0.RP05.PEGP.DGPS */
            }
        }

        Method (_PS1, 0, NotSerialized)  // _PS1: Power State 1
        {
            Store (One, _PSC) /* \_SB_.PCI0.RP05.PEGP._PSC */
        }
        ...
        Method (_PS3, 0, NotSerialized)  // _PS3: Power State 3
        {
            If (LEqual (OPCE, 0x03))
            {
                ...
                {
                    _OFF ()
                    Store (One, DGPS) /* \_SB_.PCI0.RP05.PEGP.DGPS */
                }

                Store (0x02, OPCE) /* \_SB_.PCI0.RP05.PEGP.OPCE */
            }

            Store (0x03, _PSC) /* \_SB_.PCI0.RP05.PEGP._PSC */
        }
        ...
        Method (_ROM, 2, NotSerialized)  // _ROM: Read-Only Memory
        {
            ...
            {
                Store (RBF1, ROM1) /* \_SB_.PCI0.RP05.PEGP._ROM.ROM1 */
            }
            Else
            {
                If (LLess (Local0, 0x00010000))
                {
                    ...
                    Store (RBF2, ROM1) /* \_SB_.PCI0.RP05.PEGP._ROM.ROM1 */
                }
                Else
                {
                    If (LLess (Local0, 0x00018000))
                    {
                        ...
                        Store (RBF3, ROM1) /* \_SB_.PCI0.RP05.PEGP._ROM.ROM1 */
                    }
                    Else
                    {
                        If (LLess (Local0, 0x00020000))
                        {
                            ...
                            Store (RBF4, ROM1) /* \_SB_.PCI0.RP05.PEGP._ROM.ROM1 */
                        }
                    }
                }
            }
            ...
            Store (TMPB, ROM2) /* \_SB_.PCI0.RP05.PEGP._ROM.ROM2 */
        ...
        Method (_ON, 0, Serialized)  // _ON_: Power On
        {
            ...
            {
                Store (CMDR, Local0)
                Store (Zero, CMDR) /* \_SB_.PCI0.RP05.PEGP.CMDR */
                Store (VGAB, VGAR) /* \_SB_.PCI0.RP05.PEGP.VGAR */
                Store (0x06, CMDR) /* \_SB_.PCI0.RP05.PEGP.CMDR */
                If (LEqual (And (SGFL, 0x02), Zero))
                {
                    Store (Zero, NHDA) /* \_SB_.PCI0.RP05.PEGP.NHDA */
                }

                Store (Local0, CMDR) /* \_SB_.PCI0.RP05.PEGP.CMDR */
            }
        ...
        Method (_OFF, 0, Serialized)  // _OFF: Power Off
        {
            If (LEqual (CTXT, Zero))
            {
                If (LNotEqual (GPRF, One))
                {
                    Store (VGAR, VGAB) /* \_SB_.PCI0.RP05.PEGP.VGAB */
                }

                Store (One, CTXT) /* \_SB_.PCI0.RP05.PEGP.CTXT */
            }
        ...
        Method (HDSM, 4, Serialized)
        {
            ...
            If (LOr (OPCI, LOr (SGCI, NBCI)))
            {
                ...
                If (LEqual (Arg2, 0x1A))
                {
                    ...
                    Store (\_SB.PCI0.RP05.PEGP.GPRF, SNSR) /* \_SB_.PCI0.IGPU.HDSM.SNSR */
